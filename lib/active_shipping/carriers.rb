...
ActiveShipping::Carriers.register :Ems,              'active_shipping/carriers/ems'
ActiveShipping::Carriers.register :Cpcr,             'active_shipping/carriers/cpcr'
ActiveShipping::Carriers.register :Russianpost,      'active_shipping/carriers/russianpost'
ActiveShipping::Carriers.register :FirstClass,       'active_shipping/carriers/first_class'
